...
## [#](https://mszlu.com/go/gorm/02/02.html#_1-模型定义)1. 模型定义
...
## [#](https://mszlu.com/go/gorm/02/02.html#_2-模型标签)2. 模型标签
...
## [#](https://mszlu.com/go/gorm/02/02.html#_3-表名映射)3. 表名映射
...
## [#](https://mszlu.com/go/gorm/02/02.html#_4-model)4. Model
...
## [#](https://mszlu.com/go/gorm/02/02.html#_5-数据库连接)5. 数据库连接
...
### [#](https://mszlu.com/go/gorm/02/02.html#_5-1-dsn)5.1 DSN
...
### [#](https://mszlu.com/go/gorm/02/02.html#_5-2-连接数据库)5.2 连接数据库
...
### [#](https://mszlu.com/go/gorm/02/02.html#_5-3-调试模式)5.3 调试模式

```go
db.Debug()
```

### [#](https://mszlu.com/go/gorm/02/02.html#_5-4-连接池配置)5.4 连接池配置
